...
class Pomodoro extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Material(
      ...
      **/
                  GestureDetector(
                onTap: () => Navigator.pushNamed(context, '/Time_'),
                child: ClipRRect(
                  borderRadius: BorderRadius.circular(10.0),
                  child: Container(
                    width: 136.0,
      ...
      **/
            ...
            Positioned(
              child:
                  /**
       * Text '1. Decide a task 2. Work on it for 25 minutes 3. Take a 5 minute break 4. Get back on your task 5. After 4 pomodoros, your task should be complete!'
      **/
                  Text(
                '''1. Decide a task 2. Work on it for 25 minutes 3. Take a 5 minute break 4. Get back on your task 5. After 4 pomodoros, your task should be complete!''',
                overflow: TextOverflow.visible,
                textAlign: TextAlign.left,
                style: TextStyle(
                  height: 1.171875,
      ...
      **/
                  GestureDetector(
                onTap: () =>
                    Navigator.pushNamed(context, '/Customize_pomodoro'),
                child: Text(
                  '''CUSTOMIZE''',
                  overflow: TextOverflow.visible,
                  textAlign: TextAlign.left,
