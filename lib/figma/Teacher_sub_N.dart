...
/* FigmaFrame Teacher sub N */
class Teacher_sub_N extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Material(
      ...
      **/
                  GestureDetector(
                onTap: () => Navigator.pushNamed(context, '/assign_teach'),
                child: ClipRRect(
      ...
      **/
                  GestureDetector(
                onTap: () => Navigator.pushNamed(context, '/att_teach'),
                child: ClipRRect(
                  borderRadius: BorderRadius.circular(10.0),
                  child: Container(
                    width: 281.0,
      ...
      **/
                  GestureDetector(
                onTap: () => Navigator.pushNamed(context, '/Note_teach'),
                child: ClipRRect(
                  borderRadius: BorderRadius.circular(10.0),
                  child: Container(
                    width: 281.0,
